...
export const projects: Project[] = [
  ...
  },
  {
    ...
    stack: ['TypeScript', 'Node.js', 'Commander', 'Node Test'],
    ...
    implementation: 'AST-based source scanning, explicit environment profiles, key routing, masked inspection, preview-first edits, per-file atomic writes, and local backups. Includes a tested package, a public walkthrough, and a complete migration and command guide.',
    boundary: 'Version 0.2 is installable from GitHub source; it is not published to npm. Files and backups remain local plaintext. Multi-file routing is not transactional, and the tool does not provide a cloud secret vault.',
